...
import JunctionAndForkJoinSVG from './011-junction-and-fork-join.svg';
import JunctionExclusiveSVG from './011-junction-xor.svg';
import JunctionExclusiveJoinSVG from './011-junction-xor-join.svg';
import JunctionExclusiveForkJoinSVG from './011-junction-xor-fork-join.svg';
...
const JunctionAndForkJoinIcon = makeURL(JunctionAndForkJoinSVG);
const JunctionExclusiveIcon = makeURL(JunctionExclusiveSVG);
const JunctionExclusiveJoinIcon = makeURL(JunctionExclusiveJoinSVG);
const JunctionExclusiveForkJoinIcon = makeURL(JunctionExclusiveForkJoinSVG);
...
export {
  ...
  JunctionAndIcon,
  JunctionAndJoinIcon,
  JunctionAndForkJoinIcon,
  JunctionExclusiveIcon,
  JunctionExclusiveJoinIcon,
  JunctionExclusiveForkJoinIcon,
  IntersectionIcon,
  HappyIcon,
  WallClockIcon,
  TurnIcon,
